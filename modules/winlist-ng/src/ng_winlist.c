...
static Eina_Bool 
_ngw_winlist_window_show_timer_cb(void *data __UNUSED__)
{
   show_timer = NULL;
...
static Eina_Bool
_ngw_winlist_fade_out_timer(void *data __UNUSED__)
{
   int a;
...
static Eina_Bool
_ngw_winlist_bring_to_front_cb(void *data __UNUSED__)
{
...
static Eina_Bool
_ngw_winlist_cb_event_border_add(void *data __UNUSED__, int type __UNUSED__, void *event)
{
...
static Eina_Bool
_ngw_winlist_cb_event_border_remove(void *data __UNUSED__, int type __UNUSED__, void *event)
{
...
static Eina_Bool
_ngw_winlist_cb_key_down(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   Ecore_Event_Key *ev;
...
static Eina_Bool
_ngw_winlist_cb_key_up(void *data __UNUSED__, int type __UNUSED__, void *event)
{
   Ecore_Event_Key *ev;
...
/*
static int
_ngw_winlist_warp_timer(void *data __UNUSED__)
{
   if (warp_to)
     {
       double x, y;
...
static int
_ngw_winlist_animator (void *data __UNUSED__)
{
   if (warp_to)
     {
       int dx, dy;
...
static Eina_Bool
_ngw_winlist_cb_mouse_wheel(void *data __UNUSED__, int type __UNUSED__, void *event)
{
